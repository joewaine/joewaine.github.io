...
var img4 = document.querySelector("#displacementFilter4 feTurbulence");
var frames4 = 0;


function AnimateBaseFrequency4() {
  //baseFrequency="0.01 .1"
  bfx = 0.01;
  bfy = .1;
  bfy = scrollPercentage/1000;
...
//   frames += scrollPercentage;
  ...
  bf = bfx.toString() + ' ' + bfy.toString();
  img4.setAttributeNS(null, 'baseFrequency', bf);

  window.requestAnimationFrame(AnimateBaseFrequency4);
}
